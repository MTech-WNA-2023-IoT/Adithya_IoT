...
values = (data["name"],data["region"],data["country"],data["lat"],data["lon"],data["tz_id"],data["localtime_epoch"],data["localtime"],data1["cloud"],data1["temp"],data1["humidity"],data1["pressure"])
